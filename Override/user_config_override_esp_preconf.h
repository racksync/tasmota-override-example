...
// -- Project -------------------------------------
#undef PROJECT
#define PROJECT "RACKSYNC-EMON" // PROJECT is used as the default topic delimiter

//#undef MODULE
//#define MODULE                 SONOFF_BASIC     // [Module] Select default model from sonoff_template.h (Should not be changed)

//#undef FALLBACK_MODULE 
//#define FALLBACK_MODULE ESP8266
...
// Template for PZEM 
// D1 ต่อ TX = GPIO5 = "PZEM016 TX"
// D2 ต่อ RX = GPIO4 = "PZEM0XX RX"
#define USER_TEMPLATE "{\"NAME\":\"RACKSYNC EMON\",\"GPIO\":[1,0,1,1,1536,1472,1,1,1,1,1,1,1,1],\"FLAG\":0,\"BASE\":18}" // [Template] Set JSON template
